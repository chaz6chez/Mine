...
class Arr {
     ...
     */
    public static function mapTree($array, $callback, $cbkIn = null, $cbkOut = null, $childrenKey = 'children') {
        $stack = []; // [index, list]
        array_push($stack, [0, $array]);
        ...
        while (true) {
            ...
            if (isset($row[$childrenKey])) {
                ...
                array_push($stack, [0, $row[$childrenKey]]);
            }
        }
    }
