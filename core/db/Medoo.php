...
class Medoo {
    ...
    public function __construct(array $options) {
        ...
        $this->option = isset($options['option']) ? $options['option'] : [];
...
//        $this->command();
    ...
    public function delete($table, $where, $multiTables = null) {
        $map = [];

        if ($multiTables) {
            return $this->exec('DELETE ' . ($multiTables ? $multiTables . ' ' : '') . 'FROM ' . $this->tableQuote($table) . $this->whereClause($where, $map), $map);
        }
